...
- W3: Representing information in the computer (continued); [Chapter 1: Values, types, and operators.](https://eloquentjavascript.net/01_values.html) [Slides](week2_slides.pptx); [Homework assignments](week3.md)
